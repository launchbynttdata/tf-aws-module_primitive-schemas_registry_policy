...
This Terraform module creates an [AWS EventBridge Schema Registry Policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/schemas_registry_policy) resource.
...
| Name | Type |
|------|------|
| [aws_schemas_registry_policy.policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/schemas_registry_policy) | resource |

## Inputs

| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_policy"></a> [policy](#input\_policy) | JSON resource-based policy document for the schema registry. | `string` | n/a | yes |
| <a name="input_registry_name"></a> [registry\_name](#input\_registry\_name) | Name of the schema registry to attach the resource policy to. | `string` | n/a | yes |
